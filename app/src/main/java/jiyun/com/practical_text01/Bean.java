package jiyun.com.practical_text01;
...
class Bean{
    ...
    public static class DataBean {
        ...
        public DataBean(String id, String goods_name, double shop_price, int market_price, boolean is_coupon_allowed, boolean is_allow_credit, String goods_img, int sales_volume, String efficacy, String goods_type, double activityPrice, int sort) {
            this.id = id;
